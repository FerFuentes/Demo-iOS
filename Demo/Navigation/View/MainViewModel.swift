...
class MainViewModel: ObservableObject {
    @Published var  sample: [NavigationModel]  = [
        ...
        NavigationModel(id: "4", key: .messages, iconURL: "https://cdn-icons-png.flaticon.com/512/9446/9446889.png", action: .openURL(url: "https://www.google.com", showTitle: false))
    ]
